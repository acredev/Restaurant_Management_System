 ...
 * Generated at: 2023-04-18 02:16:31 UTC
	...
	out.println("페이지 처리 중, 오류가 발생했습니다. 아래의 오류 메시지를 참고하여 페이지 관리자에게 문의 바랍니다. 불편을 드려 죄송합니다.\n" + ex.getMessage());
      ...
      out.write("								");
							...
							try
							{
    							...
    							String idChkQuery = "SELECT COUNT(*) as cnt FROM kyungmin_store.member WHERE id=?";
      ...
      out.write("\r\n");
      out.write("            							alert(\"");
      out.print( request.getParameter("idchk") );
      out.write(" 아이디는 사용 가능한 아이디입니다.\");\r\n");
      out.write("            							");
      ...
      out.write("\r\n");
      out.write("                							alert(\"중복된 아이디입니다. 다른 아이디를 사용해 주세요.\");\r\n");
      out.write("                							");
      ...
      out.write("\r\n");
      out.write("            						alert(\"오류가 발생했습니다. 오류 메시지 : ");
      out.print( ex.getMessage() );
      out.write(" 불편을 드려 죄송합니다.\");\r\n");
      out.write("            					");
