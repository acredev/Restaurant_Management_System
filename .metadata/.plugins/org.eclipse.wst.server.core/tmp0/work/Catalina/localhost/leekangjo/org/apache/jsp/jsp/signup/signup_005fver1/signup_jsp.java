 ...
 * Generated at: 2023-04-21 12:15:47 UTC
...
catch (Exception ex)
{
	out.println("페이지 처리 중, 오류가 발생했습니다. 아래의 오류 메시지를 참고하여 페이지 관리자에게 문의 바랍니다. 불편을 드려 죄송합니다.\n" + ex.getMessage());
      ...
      out.write("			{\r\n");
      out.write("				if (document.signup.tel.value == \"\" || document.signup.tel.length < 0)\r\n");
      out.write("				{\r\n");
      out.write("					alert(\"전화번호 입력 후 다시 시도해 주세요.\");\r\n");
      out.write("					document.signup.tel.focus();\r\n");
      out.write("				}\r\n");
      out.write("				else\r\n");
      out.write("				{\r\n");
      out.write("					window.open(\"signup_telchk.jsp?tel=\" + document.signup.tel.value, \"\", \"width=500, height=300\");\r\n");
      out.write("				}\r\n");
      out.write("				//window.open(\"signup_telchk.jsp?tel=\" + document.signup.tel.value, \"\", \"width=500, height=300\");\r\n");
      out.write("			}\r\n");
      out.write("		</script>\r\n");
      ...
      out.write("					<input type=\"button\" class=\"tel_check\" onclick=\"telchk()\" value=\"본인인증\">\r\n");
      out.write("				</div>\r\n");
      out.write("				<div>\r\n");
